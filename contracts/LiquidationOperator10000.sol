...
contract LiquidationOperator10000 is IUniswapV2Callee {
    ...
    function operate() external {
        ...
        WBTC.transfer(address(uniswapV2Pair_WBTC_WETH), bal);
        uint amountOut_WETH = getAmountOut(bal, reserve_WBTC_Pool2, reserve_WETH_Pool2);
    ...
    function uniswapV2Call(
        ...
        (uint256 reserve_WBTC_Pool1, uint256 reserve_USDT_Pool1, ) = uniswapV2Pair_WBTC_USDT.getReserves();
